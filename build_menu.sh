...
gcc -O3 -c low.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
...
gcc -O3 -c lowfont.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
	-I/usr/X11R7/include -I/usr/pkg/include \
	-DUSESSL -Issl/include/openssl -O3 \
	-L/usr/local/lib -I/usr/local/include \
	-I/root/zaloha/ipc/freetype/include \
...
gcc -O3 -c sys.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
	-I/usr/X11R7/include -I/usr/pkg/include \
	-DUSESSL -Issl/include/openssl -O3 \
	-L/usr/local/lib -I/usr/local/include \
	-I/root/zaloha/ipc/freetype/include \
...
#gcc -O3 -o wm2a wm2a.o system.o systemoo.o \
#       sys.o \
#	rss.o \
#	agg.o \
...
gcc -O3 -c rss.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
	-I/usr/X11R7/include -I/usr/pkg/include \
	-DUSESSL -Issl/include/openssl -Lssl/lib \
	-I/usr/local/include -L/usr/local/lib \
	-I/root/zaloha/ipc/freetype/include \
...
gcc -O3 -c menu.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
	-I/usr/X11R7/include -I/usr/pkg/include \
	-DUSESSL -Issl/include/openssl -Lssl/lib \
	-I/usr/local/include -L/usr/local/lib \
	-I/root/zaloha/ipc/freetype/include \
...
gcc -O3 -c simple.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
	-I/usr/X11R7/include -I/usr/pkg/include \
	-DUSESSL -Issl/include/openssl -Lssl/lib \
	-I/usr/local/include -L/usr/local/lib \
	-I/root/zaloha/ipc/freetype/include \
...
gcc -O3 -c xlib.c -DUNIX -DGUI -DUSEX -DJPEG -L/usr/X11R6/lib -L/usr/pkg/lib -L/usr/lib \
	-I/usr/X11R7/include -I/usr/pkg/include \
	-DUSESSL -Issl/include/openssl -Lssl/lib \
	-I/usr/local/include -L/usr/local/lib \
	-I/root/zaloha/ipc/freetype/include \

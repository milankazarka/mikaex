...
#include <string.h>
  ...
  **********************************************************************/
  ...
  extern grSurface*  grNewSurface( void		*win,
                                   ...
                                   grBitmap*    bitmap )
  {
    ...
    if ( !device->init_surface( win, surface, bitmap ) )
    {
      grFree( (void *)surface );
      surface = 0;
    }
  ...
  **********************************************************************/
  ...
  extern void grSetPixbuf( grSurface* surface, void *pixbuf )
  {
   surface->set_pixbuf( surface, pixbuf );
  }
  ...
  **********************************************************************/
  ...
  extern
  long  grGetSysId( grSurface *surface )
  {
   return surface->get_sys_id( surface );
  }

  extern
  void	grSetSysId( grSurface *surface, void *win )
  {
   surface->set_sys_id( surface, win );
  }

...
#include "gblblit.h"
  ...
  static double    gr_glyph_gamma = 1.2; // 1.2
                       ...
                       grColor    color )
  {
    ...
    printf("_ft blitting start target grBitmap(%d %d %d) glyph(%d)\n",
     target->pitch,target->mode,target->grays,
     glyph->mode);
    ...
    printf("_ft blitting after_checks\n");
  ...
  DefaultBlit:
    ...
    printf("_ft blitting default_blit\n");
    ...
    printf("_ft blitting after compute_clips\n");

    switch ( glyph->mode )
    {
    case gr_pixel_mode_mono:     /* handle monochrome bitmap blitting */
      printf("_ft blitting MONO\n");
    ...
    default:
      printf("_ft blitting NONE unsupported\n");

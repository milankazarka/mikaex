...
#include "grtypes.h"
  ...
  **********************************************************************/
  ...
  typedef long (*grGetSysIdFunc)( grSurface *surface ); // mika

  typedef void (*grSetPixbufFunc)( grSurface *surface, void *pixbuf );

  typedef void (*grSetSysWindowFunc)( grSurface *surface, void *win );
  ...
  struct grSurface_
  {
    ...
    grGetSysIdFunc     get_sys_id;
    grSetSysWindowFunc set_sys_id;
    grSetPixbufFunc    set_pixbuf;
  };

...
#define _SCHEDULLER_TIMER 	5000
#define _SCHEDULLER_EXPOSE	20000
#define _SCHEDULLER_BUTTON	200000  // a time delay after which the button event is triggered
#define _SCHEDULLER_MOTION	300000  // a time delay before other events are accepted
#define _SCHEDULLER_SLOPPY_NO

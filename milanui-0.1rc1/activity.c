...
)
{
  ...
  #ifdef _DEBUG
    printf("activityRegisterOverSocket start\n");
  #endif
  ...
  sprintf((char*)msg,"NEWACT\nANAME %s\nSHMID %d\nSEMID %d\nSHMSZ %d\n",
    ...
    act->sem->id,
    act->shm->size);
  trop_IPCUdsHandshake(client,"./draqie.sock",(char*)msg);
  free(client);
  #ifdef _DEBUG
...
{
  static struct activityData *aData = NULL;
...
{
  static struct activityEvent *event = NULL;
  static struct activityData *aData = NULL;
  ...
  #ifdef _DEBUG
    printf("activityAddEventButtonDown\n");
  #endif
  ...
  #ifdef _DEBUG
    printf("activityAddEventButtonDown finish\n");
  #endif
...
)
{
  ...
  #ifdef _DEBUG
    printf("activityAddEventButtonUp\n");
  #endif
  ...
  #ifdef _DEBUG
    printf("activityAddEventButtonUp finish\n");
  #endif
...
)
{
  ...
  #ifdef _DEBUG
    printf("activityAddEventRepaint\n");
  #endif
  ...
  #ifdef _DEBUG
    printf("ctivityAddEventRepaint finish\n");
  #endif
    
  return 0;
}

int activityEventActive( // activityData
  struct activity *act
)
{  
  int active = 0;
...
int activityEventIsEvent( // activityData
  struct activity *act,
  int type
)
{
...
int activityGetVisible( struct activity *act, int sync )
{
  ...
  if (sync==1) activityUnlock(act);
  #ifdef _DEBUG
    printf("activityGetVisible finish\n");
  #endif
  return visible;
}
